        ...
        <div className={cn("relative group", className)}>
            ...
            <div className={cn(
                ...
                <div className="flex flex-col sm:flex-row gap-6 md:gap-8 items-center sm:items-start relative z-10">
                    ...
                    {/* Content Zone */}
                    <div className="flex-1 space-y-4 md:space-y-6 text-left w-full">
                        <div className="flex items-center gap-2 md:gap-3">
                            <div className={cn(
                                "p-1 rounded-lg",
                                isHighEnd ? "bg-yellow-500/10" : "bg-emerald-500/10"
                            )}>
                                <Sparkles size={12} className={isHighEnd ? "text-yellow-400" : "text-emerald-400"} />
                            </div>
                            <h4 className={cn(
                                "text-[10px] md:text-[12px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em]",
                            ...
                            {insights.map((insight, idx) => {
                                ...
                                return (
                                    <motion.div 
                                        ...
                                        className="flex items-start gap-3 md:gap-5 group/item"
                                    >
                                        <div className={cn(
                                            "mt-0.5 flex items-center justify-center shrink-0 w-4.5 h-4.5 md:w-6 md:h-6 rounded-lg md:rounded-xl border transition-all duration-500 rotate-45 group-hover/item:rotate-90",
                                            isWarning 
                                        ...
                                        <p className={cn(
                                            "flex-1 text-[13px] md:text-[16px] font-bold leading-[1.6] md:leading-[1.7] tracking-tight transition-all duration-300",
                        ...
                        <div className="pt-6 flex flex-wrap items-center gap-4 border-t border-white/5">
                            <div className={cn(
                                ...
                                <ShieldCheck size={12} className={isHighEnd ? "text-yellow-400" : "text-emerald-400"} />
                                <span className={cn(
                                    "text-[10px] font-black uppercase tracking-[0.1em]",
                                    isHighEnd ? "text-yellow-400/80" : "text-slate-400"
                                )}>
                                    {((t as any).analysis?.verifiedBy) || (isKo ? "ZESTPAIR BLACK LABEL AUTHENTICATED" : "ZESTPAIR BLACK LABEL AUTHENTICATED")}
                                </span>
                            </div>
