...
const PORI_MESSAGES_JA = [
  "こんにちは！私は相互作用マスターのPoriだよ！ 🧪✨",
  "今日もあなたの栄養バランスのためにPori稼働！ 🚀",
  "よろしくね！今日はどんなサプリメントが私のドームに入ってくるかな？ 🧪",
  "サプリメント同士がケンカしないように私がしっかりチェックするね！ 🛡️",
  "一緒に飲めば効果が2倍！そんな最高の組み合わせだけを見つけてあげる！ 🧬",
  "サプリメントカゴを満たしてみて！Poriレーダーが作動中だよ！ 🛰️",
  "気になる組み合わせがあれば、ためらわずに私をクリックしてね！ 😎",
  "複雑な科学分析もPoriにとっては朝飯前さ！ 🔬",
  "成分たちの隠された運命を読み解くのが私の特技だよ！ ✨",
  "ナノ粒子レベルで精密なマッチングシステム稼働中！ 🧬",
  "健康な明日のための完璧なバランス、Poriが見つけてあげる！ 🌈",
  "水分は十分に摂ってる？水分補給も大切だよ！ 💧",
  "疲れた時は少し目を閉じて、Poriのヒーリングエネルギーを受け取ってみて！ ✨",
  "あなたの健康資産、Poriがしっかり守るね！ 💎",
  "ビタミンCと鉄分は最高のパートナー！吸収率がグンと上がるよ！ 🍊+⛓️",
  "カルシウムとマグネシウムは2:1の比率が理想的。Poriがチェックするね！ ⚖️",
  "オメガ3は食後に飲むと吸収が良くなるって知ってた？役立つでしょ？ 🐟",
  "脂溶性ビタミンは脂肪と一緒に！もっと賢く摂取しよう！ 🥑",
  "鉄分とカルシウムはお互いの吸収を妨げるよ！時間をずらすのがポイント！ 🛡️",
  "ビタミンDはカルシウムの吸収を助ける最高の青いサポーターだよ！ ☀️",
  "マルチビタミンにすでに含まれている成分がないか、Poriが見てみるね！ 🔍",
  "カフェインは一部の栄養素の吸収を妨げるから注意が必要だよ！ ☕",
  "私のドーム内の粒子が今日はとっても活発！シナジーの予感！ ⚡",
  "ポポポ〜Pori中！最高の組み合わせを探してるよ！ 🍱",
  "カゴにサプリメントが入るたびに私の心もドキドキ！ 💓",
  "Poriはあなた専用のAI栄養士なんだから！ 👩‍🔬",
];

const PORI_MESSAGES_ZH = [
  "你好！我是相互作用大师 Pori！ 🧪✨",
  "今天也为了您的营养平衡启动 Pori！ 🚀",
  "很高兴见到您！今天会有哪些营养补充品进入我的圆顶呢？ 🧪",
  "我会仔细检查，确保营养补充品之间不会发生冲突！ 🛡️",
  "一起服用效果加倍！我只会为您寻找这样的最佳组合！ 🧬",
  "填满您的营养补充品篮子吧！Pori 雷达正在运行中！ 🛰️",
  "如果对某些组合感到好奇，请毫不犹豫地点击我！ 😎",
  "复杂的科学分析对 Pori 来说也是小菜一碟！ 🔬",
  "解读成分之间隐藏的命运是我的特长！ ✨",
  "纳米级别的精密匹配系统正在运行中！ 🧬",
  "为了健康的明天，Pori 会为您找到完美的平衡！ 🌈",
  "您喝了足够的水吗？补充水分也很重要！ 💧",
  "疲劳时请闭上眼睛，感受 Pori 的治愈能量！ ✨",
  "您的健康资产，Pori 会坚定地守护！ 💎",
  "维生素 C 和铁是梦幻组合！吸收率会直线飙升！ 🍊+⛓️",
  "钙和镁的比例为 2:1 是最理想的。Pori 会帮您检查的！ ⚖️",
  "Omega-3 在饭后服用吸收更好！这个知识很有用吧？ 🐟",
  "脂溶性维生素要和脂肪一起！让我们更聪明地摄取吧！ 🥑",
  "铁和钙会互相阻碍吸收！错开时间是关键！ 🛡️",
  "维生素 D 是帮助钙吸收的最佳蓝色助手！ ☀️",
  "综合维生素中是否已经包含某些成分，Pori 会帮您查看！ 🔍",
  "咖啡因会阻碍部分营养素的吸收，需要注意！ ☕",
  "我圆顶内的粒子今天特别活跃！预感会有协同作用！ ⚡",
  "Po-po-po~ Pori 中！正在寻找最佳契合度！ 🍱",
  "每当营养补充品放入篮子时，我的心也会砰砰直跳！ 💓",
  "Pori 可是您专属的 AI 营养师哦！ 👩‍🔬",
];
...
export default function FloatingAssistant() {
  ...
  const messages = language === "ko" ? PORI_MESSAGES_KO : language === "ja" ? PORI_MESSAGES_JA : language === "zh" ? PORI_MESSAGES_ZH : PORI_MESSAGES_EN;
